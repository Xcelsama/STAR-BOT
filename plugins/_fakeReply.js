...
handler.all = async function (m) {
   ...
   global.rpl = { contextInfo: { externalAdReply: { mediaUrl: dygp, mediaType: 'VIDEO', description: 'support group', title: packname, body: 'support group', thumbnailUrl: pp, sourceUrl: dygp }}} 
	...
	//reply link yt
    global.rpyt = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: fgyt, mediaType: 'VIDEO', description: 'Suscribete : ' + fgyt, title: '乇乂匚乇ㄥ', body: 'ㄒ乇匚卄 乂', thumbnailUrl: pp, sourceUrl: fgyt }}}
